                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            ...
                                            <div class="mb-3">
                                                <label for="add-bot-descripton" class="form-label">简介</label>
                                                <textarea v-model="botadd.description" type="form-control"
                                                    class="form-control" id="add-bot-descripton" rows="3"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="add-bot-descripton"
                                                                class="form-label">简介</label>
                                                            <textarea v-model="bot.description" type="form-control"
                                                                class="form-control" id="add-bot-descripton" rows="3"
                                                                placeholder="请输入bot简介"></textarea>
                                                        </div>
                                                        <div class="mb-3">
...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "https://app4579.acapp.acwing.com.cn/api/user/bots/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app4579.acapp.acwing.com.cn/api/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const update_bot = (bot) => {
            bot.error_message = "";
            $.ajax({
                url: "https://app4579.acapp.acwing.com.cn/api/user/bots/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app4579.acapp.acwing.com.cn/api/user/bots/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
